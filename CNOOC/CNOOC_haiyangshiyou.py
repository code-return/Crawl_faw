...
def parse_one_page(html):
    ...
    province = '中国海洋石油集团有限公司'
    province_file = '中国海洋石油集团有限公司'

    selector = etree.HTML(html)

    time = selector.xpath("//*[@id='categorypagingcontent']/ul/li[@class='now-hd-items clearfix']/span/text()")
    title = selector.xpath("//*[@id='categorypagingcontent']/ul/li[@class='now-hd-items clearfix']/a/@title")
    href = selector.xpath("//*[@id='categorypagingcontent']/ul/li[@class='now-hd-items clearfix']/a/@href")
...
def getContent(url):
    ...
    if response.status_code == 200:
        ...
        # 用get_text()将其转换为str
        div = soup.find_all('div','article-Content')[0].get_text()
